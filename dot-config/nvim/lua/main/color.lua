-- Forked from https://github.com/p00f/alabaster.nvim
...
local comment_fg = "#dfdf8e"
local pmenu_bg = "#182325"
local float_bg = "none"
local floatborder = { bg = float_bg, fg = fg }

local key_fg = "#71aed7"
local linenr_fg = key_fg
local func_fg = fg
local macro_fg = "#e6984c"
local func_macro_fg = macro_fg
local const_macro_fg = macro_fg
theme = {
    ...
    LineNr = { fg = linenr_fg },
    LineNrAbove = { fg = "#5c5c5c" },
    LineNrBelow = { fg = "#5c5c5c" },
    ...
    DiagnosticUnderlineError = { underline = true, bold = true, sp = error },
    DiagnosticUnderlineWarn = { underline = true, sp = warn },
    DiagnosticUnderlineInfo = { underline = true, sp = info },
    DiagnosticUnderlineHint = { underline = true, sp = hint },
    DiagnosticUnderlineOk = { underline = false, sp = ansi.white },
    ...
    TSConstMacro = { fg = const_macro_fg },
    ...
    ["@constant.macro"] = { fg = const_macro_fg },
    ["@error"] = { bg = mistake.bg, fg = mistake.fg },
    ["@exception"] = { fg = ansi.white },
    ["@field"] = { fg = ansi.white },
    ["@function"] = { fg = func_fg },
    ["@function.builtin"] = { fg = func_fg },
    ["@function.macro"] = { fg = func_macro_fg },
    ["@keyword"] = { fg = key_fg },
    ["@keyword.function"] = { fg = key_fg },
    ["@label"] = { fg = ansi.white },
    ["@method"] = { fg = func_fg },
    ...
    ["@comment.error"] = { fg = error, bold = true, underline = true, sp = error },
    ["@comment.warning"] = { fg = warn, bold = true, underline = true, sp = warn },
    ["@comment.todo"] = { fg = error, bold = true, underline = true, sp = error },
}
